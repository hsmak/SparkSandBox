...
object JoinExample extends App with MyContext {
  ...
  println("self join") // An example of showing whose manager is an employee
  empDF.as("emp1") // an alias for the DataFrame; similar to the alias to the Column
    // DataFrame/Table is joining onn itself
